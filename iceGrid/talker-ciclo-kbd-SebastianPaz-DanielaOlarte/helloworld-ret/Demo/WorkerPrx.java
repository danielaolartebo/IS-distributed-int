...
public interface WorkerPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void getResponse(String task)
    {
        getResponse(task, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void getResponse(String task, java.util.Map<String, String> context)
    {
        _iceI_getResponseAsync(task, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> getResponseAsync(String task)
    {
        return _iceI_getResponseAsync(task, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> getResponseAsync(String task, java.util.Map<String, String> context)
    {
        return _iceI_getResponseAsync(task, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_getResponseAsync(String iceP_task, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getResponse", null, sync, null);
    ...
    default void getConnect(String connection)
    {
        getConnect(connection, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void getConnect(String connection, java.util.Map<String, String> context)
    {
        _iceI_getConnectAsync(connection, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> getConnectAsync(String connection)
    {
        return _iceI_getConnectAsync(connection, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> getConnectAsync(String connection, java.util.Map<String, String> context)
    {
        return _iceI_getConnectAsync(connection, context, false);
    }

    /**
     * @hidden
     * @param iceP_connection -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_getConnectAsync(String iceP_connection, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getConnect", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     ostr.writeString(iceP_connection);
                 }, null);
        return f;
    }
