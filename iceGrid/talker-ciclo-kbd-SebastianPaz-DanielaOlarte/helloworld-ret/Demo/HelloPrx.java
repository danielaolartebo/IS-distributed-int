...
public interface HelloPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default void request(WorkerPrx wk, String request)
    {
        request(wk, request, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void request(WorkerPrx wk, String request, java.util.Map<String, String> context)
    {
        _iceI_requestAsync(wk, request, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> requestAsync(WorkerPrx wk, String request)
    {
        return _iceI_requestAsync(wk, request, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> requestAsync(WorkerPrx wk, String request, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_requestAsync(WorkerPrx iceP_wk, String iceP_request, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "request", null, sync, null);
        f.invoke(false, context, null, ostr -> {
    ...
    default void getTask(WorkerPrx wk)
    {
        getTask(wk, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void getTask(WorkerPrx wk, java.util.Map<String, String> context)
    {
        _iceI_getTaskAsync(wk, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> getTaskAsync(WorkerPrx wk)
    {
        return _iceI_getTaskAsync(wk, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> getTaskAsync(WorkerPrx wk, java.util.Map<String, String> context)
    {
        return _iceI_getTaskAsync(wk, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_getTaskAsync(WorkerPrx iceP_wk, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default void shutdown(int id)
    {
        shutdown(id, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void shutdown(int id, java.util.Map<String, String> context)
    {
        _iceI_shutdownAsync(id, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> shutdownAsync(int id)
    {
        return _iceI_shutdownAsync(id, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> shutdownAsync(int id, java.util.Map<String, String> context)
    {
        return _iceI_shutdownAsync(id, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_shutdownAsync(int iceP_id, java.util.Map<String, String> context, boolean sync)
    {
